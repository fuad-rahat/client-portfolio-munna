      ...
      <div className="max-w-6xl mx-auto flex relative left-[4rem]">
        ...
        <div className="w-1/2 bg-[#B2CED59C] flex flex-col">
            ...
            <>
              ...
              <div className={`flex flex-col  gap-5 mt-66`}>
            <button className="bg-[#5833FB] text-white p-3">Hire Me</button>
            <button className="border-[#5833FB] border-[0.1rem] text-[#5833FB] p-3 px-5">
              My Resume
            </button>
          </div>
              </div>
           ...
           <div className="w-[40rem] h-[37rem] flex justify-center relative right-[7rem] items-center flex-col">
             ...
             <div className="text-center max-w-sm font-bold">
              ...
              <p>I am a student at Daffodil International University, pursuing a BSc in Software Engineering. Additionally, I work as a UI/UX designer.</p>
             </div>
